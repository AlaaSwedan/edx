...
return DataTable;}));require(['jquery','dataTablesBootstrap'],function($){'use strict';$(function(){$('#programOfferTable').DataTable({paging:true});});});define("js/pages/program_offer_list_page",function(){});